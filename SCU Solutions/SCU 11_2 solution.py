...
# Add a line of code to create a fourth radiobutton with the text "Choice 4"
#  That when selected assigns the value of 4 to the variable var1.  Assign this
#  to a widget named mw_rbchoice4 and locate this radiobutton directly 
#  below the radiobutton that has the text "Choice 3"
mw_rbchoice4 = Radiobutton(mw_frame,text="Choice 4", value=4, variable=var1,\
               font=("Helvetica", 14)).grid(row=9, column=1)

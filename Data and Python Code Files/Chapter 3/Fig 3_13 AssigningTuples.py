# This Python code works with a tuple object

taxi_ride_info = ("da7a62fce04" , 180, 1.1, True)   # This assigns four different objects to the tuple

print("The data type for the taxi_ride_info variable is: ", type(taxi_ride_info))

# The following code prints out the data type of each element of the tuple 
